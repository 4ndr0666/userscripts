...
(() => {
  ...
  async function processImage(imgElement) {
    ...
    try {
      ...
      console.log("⦑ 4ndr0tools - Watermark++ ⦒ processed image");
    } catch (error) {
      console.warn("⦑ 4ndr0tools - Watermark++ ⦒ failed to process image:", error);
  ...
  var processAllImages = () => {
    ...
    console.log(`⦑ 4ndr0tools - Watermark++ ⦒: Found ${images.length} images to process`);
  ...
  var setupMutationObserver = () => {
    ...
    console.log("⦑ 4ndr0tools - Watermark++ ⦒: MutationObserver active");
  };
  ...
  unsafeWindow.fetch = async (...args) => {
    ...
    if (GEMINI_URL_PATTERN.test(url)) {
      console.log("⦑ 4ndr0tools - Watermark++ Ψ ⦒: intercepting...", url);
  ...
  (async function init() {
    try {
      ...
      console.log("⦑ Ψ💀 4ndr0tools - Watermark++ 💀Ψ ⦒:  Ψ");
    } catch (error) {
