...
| RedteamRecon | [4ndr0tools - RedteamRecon.user.js](./4ndr0tools%20-%20RedteamRecon.user.js) | Red-team tool for conducting recon on targetsCaptures browser state and all API requests/responses (XHR/Fetch) without modification. For educational and lab use only. |
