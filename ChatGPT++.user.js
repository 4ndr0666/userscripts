...
// @version      1.0
// @description  Adds widescreen, customizable prompt buttons, and code copy button functions.
// @author       4ndr0666
...
(function() {
   ...
   * Adds a fixed top bar with clickable prompt buttons that auto-fill the ChatGPT input.
   * ============================================================ */
  ...
  function initCopyCodeButton() {
    const copyToClipboard = function(text, button) {
    ...
    const observeCodeBlocks = function() {
  ...
  /* ============================================================
   * Initialization: Once the DOM is ready, initialize all modules.
   * ============================================================ */
