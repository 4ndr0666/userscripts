...
| 4ndr0serviceguard Companion | [4ndr0tools - 4ndr0serviceguard Companion.user.js](./4ndr0tools%20-%204ndr0serviceguard%20Companion.user.js) | Ghost Protocol for Violentmonkey — Default-deny Service Worker & WebSocket control with whitelist |
