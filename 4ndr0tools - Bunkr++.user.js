...
// @version      5.0.0
// @author       4ndr0666
// @description  Part of 4ndr0tools: Canonical routing, auto-sort, hide visited, dl bypass + m3u8 Stream Extractor with Native XOR Decryption
...
(function () {
    ...
    function forceLargestFirst() {
        ...
        const sortInterval = setInterval(() => {
            ...
            const sizeBtn =
                document.querySelector('.btnSize, .sort-size, button[title*="size"], a[href*="sort=size"]') ||
    ...
    function bootstrap() {
        ...
        // Disconnect observer on page exit
