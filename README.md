...
| AutoTranslate | [4ndr0tools - AutoTranslate.user.js](./4ndr0tools%20-%20AutoTranslate.user.js) | Automatically translates any non-English page to English via translate.goog redirect. No broken Element API. No cookies. No banners. |
...
| Bunkr++ | [4ndr0tools - Bunkr++.user.js](./4ndr0tools%20-%20Bunkr++.user.js) | Direct URL routing, auto-sort, hide visited, bypass dl gateway, bulk download |
...
| Maximize_Any_Media | [4ndr0tools - Maximize_Any_Media.user.js](./4ndr0tools%20-%20Maximize_Any_Media.user.js) | Adds PIP and Maximize buttons to all media. |
...
| Prompt Master | [4ndr0tools - Prompt Master.user.js](./4ndr0tools%20-%20Prompt%20Master.user.js) | Universal Prompt Manager — v28 adds the Ψ Organization Engine: collections, saved views, favorites, ratings, archive, group-by, and insights for large prompt libraries. v28.0.1 hotfix: repaired the expanded view's open path (sidebar scroll-wrap ordering), the Move-to-Collection dialog, and the filter-dropdown lifecycle. |
