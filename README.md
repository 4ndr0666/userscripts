...
| Bunkr++ | [4ndr0tools - Bunkr++.user.js](./4ndr0tools%20-%20Bunkr++.user.js) | Part of 4ndr0tools: Direct URL routing, auto-sort, hide visited, bypass dl gateway, bulk download |
...
| Counter-surveillance | [4ndr0tools - Counter-surveillance.user.js](./4ndr0tools%20-%20Counter-surveillance.user.js) | Part of 4ndr0tools: counter-surveillance toolkit integrates deep DOM sinkholing, network nullification (WebRTC/Fetch/XHR), canvas blinding, anti-user patterns, frustrating UI constraints and aggressive URL sanitization (Google/ICC/Aliyun) |
