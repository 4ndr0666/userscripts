...
| Hailuo++ | [4ndr0tools - Hailuo++.user.js](./4ndr0tools%20-%20Hailuo++.user.js) | Enterprise-grade, idempotent automation engine for HailuoAI featuring image/video processing, advanced mutation defense, comprehensive telemetry, prompt queuing, Spintax, and bulk operations. |
...
| Instagram++ | [4ndr0tools - Instagram++.user.js](./4ndr0tools%20-%20Instagram++.user.js) | Tab-Bar + Dock Integration. Hotkey trigger (Alt+I). Ad-Blocking. Deep-Stack Recovery. |
