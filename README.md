...
| Hailuo++ | [4ndr0tools - Hailuo++.user.js](./4ndr0tools%20-%20Hailuo++.user.js) | Enhanced endpoint interception, status bypass, and obfuscation. Fortified with active anti-analysis and perception warfare modules. Security research only. |
