...
| AutoTranslate | [4ndr0tools - AutoTranslate.user.js](./4ndr0tools%20-%20AutoTranslate.user.js) | Automates Google Translate portal (EN/ES) & forces in-place global page translation, bypassing native browser engines. |
...
| Media Player Controller | [4ndr0tools - Media Player Controller.user.js](./4ndr0tools%20-%20Media%20Player%20Controller.user.js) | Speed • Alt+Shift rAF Zoom/Pan • Rotation • Smart Maximize • PiP • Play • DblClick • Pause-on-Acquire • Virtual DOM Nodes • IG Story Nav • Story Repeat • Draggable HUD • Space Hotkey |
...
| Telegram_Web_Version_Redirect | [4ndr0tools - Telegram_Web_Version_Redirect.user.js](./4ndr0tools%20-%20Telegram_Web_Version_Redirect.user.js) | This script allows you to open t.me links in Web Telegram A on Firefox, Chrome, and Safari |
